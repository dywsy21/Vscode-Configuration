...
\lstset{
    basicstyle=\consolasfont\footnotesize,  % Use smaller font size
    ...
    breakatwhitespace=false, % Allow breaking anywhere, not just at whitespace
    breakindent=20pt, % Indent broken lines
    breakautoindent=true, % Auto-indent broken lines
    xleftmargin=10pt, % Add left margin
    xrightmargin=10pt, % Add right margin
